addLayer("t", {
    name: "Trans", // This is optional, only used in a few places, If absent it just uses the layer id.
    ...
    resource: "Trans", // Name of prestige currency
    ...
    hotkeys: [
        {key: "t", description: "T: To Transcend", onPress(){if (canReset(this.layer)) doReset(this.layer)}},
    ],
